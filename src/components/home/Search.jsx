...
const Search = () => {
  ...
  return (
    <div className={`${theme === 'dark' ? 'bg-dark-blue text-white' : 'bg-white text-black'} flex gap-2 shadow p-4 md:p-2 text-lg items-center rounded-md  sm:w-full md:w-[450px]`}>
      <IoSearch/>
      <input
        type="text"
