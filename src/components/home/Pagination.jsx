...
const Pagination = ({ itemsPerPage, totalItems, paginate, currentPage }) => {
  ...
  const currentPages = pageNumbers.slice(
    currentSet,
    currentSet + maxPageNumbersToShow
  );
      ...
      <ul className="flex justify-center items-center space-x-4 mt-6">
        <li>
          <button
            ...
            className="px-4 py-2 disabled:text-gray-500 disabled:cursor-not-allowed"
        ...
        {currentPages.map((number) => {
          ...
          const darkModeClasses = isCurrentPage
            ? "border-gray-100 bg-gray-100 text-very-dark-blue font-bold"
            : "text-white";
          const lightModeClasses = isCurrentPage
            ? "bg-very-dark-blue text-white font-bold"
            : "text-black border-dark-gray";
        ...
        <li>
          <button
            ...
            className="px-4 py-2 disabled:text-gray-500 disabled:cursor-not-allowed"
            disabled={currentSet >= pageNumbers.length - maxPageNumbersToShow}
          >
