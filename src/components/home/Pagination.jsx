        ...
        <nav>
            <ul className='flex justify-center items-center space-x-4 mt-6'>
                ...
                {currentPages.map(number => (
                    <li key={number} className={`border rounded-md px-2 py-1 text-base ${theme === 'dark' ? `text-white ${number === currentPage && ' border-gray-100 bg-gray-100 text-very-dark-blue font-bold'}` : `border-dark-gray text-black ${number === currentPage && 'bg-very-dark-blue text-white'}`} `}>
